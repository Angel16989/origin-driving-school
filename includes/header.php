...
$about_link = $is_index ? '#about' : $path_prefix . 'index.php#about';
$services_link = $is_index ? '#services' : $path_prefix . 'index.php#services';
$contact_link = $is_index ? '#contact' : $path_prefix . 'index.php#contact';
